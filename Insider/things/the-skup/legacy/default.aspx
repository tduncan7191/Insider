...
<body>
    <div id="container" class="skup-wrapper">
        ...
        <h2>Legacy SKUP (2012 Logic v2)</h2>
		<div id="main">
            <div class="contentBlockFull skup-header" style="padding-bottom:0;margin-bottom:0;">
				...
				<div style="padding:10px 0 0 10px; float:left;">
					<asp:HyperLink ID="ForecastsHyperLink" runat="server" NavigateUrl="forecasts/">Edit Forecasting</asp:HyperLink>
					<br /><br />
					<asp:HyperLink ID="FutureUsageHyperLink" runat="server" NavigateUrl="future-usage/" Visible="false">Edit Future Usage</asp:HyperLink>
					<br /><br />
					<asp:HyperLink ID="Legacy2011HyperLink" runat="server" NavigateUrl="2011/">2011 Logic</asp:HyperLink>
					<br />
					<asp:HyperLink ID="Legacy2012HyperLink" runat="server" NavigateUrl="2012/">2012 Logic v1</asp:HyperLink>
				</div>
